...
const brandFaqs: Record<string, { q: string; a: string }[]> = {
  ...
  'ultra-premium-direct': [
    { q: "Ultra Premium Direct est-il fabriqué en France ?", a: "Partiellement. L'enrobage final (ajout des matières grasses et des arômes) est réalisé à Agen, en France. Mais les croquettes semi-finies sont sourcées chez des sous-traitants européens — ce n'est donc pas un 100 % Made in France strict. C'est un point sur lequel la marque communique de manière relativement transparente." },
    { q: "Quel est le taux de protéines dans les croquettes Ultra Premium Direct ?", a: "Les recettes affichent entre 28 % et 40 % de protéines brutes selon la gamme — bien au-dessus des minimums FEDIAF/AAFCO pour un chien adulte. Sur certaines références chat, jusqu'à 70 % des ingrédients sont d'origine animale." },
    { q: "Ultra Premium Direct est-il sans céréales ?", a: "Plusieurs gammes sont sans céréales (formules pour chiens sensibles), d'autres en contiennent. La marque propose une variété de recettes pour s'adapter aux besoins de chaque animal — vérifie l'étiquette de la référence avant achat. Certaines formules contiennent aussi des pois en quantité non négligeable." },
    { q: "Comment fonctionne le modèle vente directe ?", a: "Ultra Premium Direct vend exclusivement en direct via son propre site (pas d'animalerie ni de grande surface). Ce circuit court permet d'économiser jusqu'à 40 % par rapport aux marques équivalentes distribuées en réseau classique. L'abonnement automatique simplifie la logistique avec un envoi récurrent." },
    { q: "Ultra Premium Direct utilise-t-il des prébiotiques ?", a: "Oui — les recettes intègrent FOS (fructo-oligosaccharides) et MOS (mannan-oligosaccharides), deux prébiotiques qui soutiennent le microbiote intestinal du chien. C'est l'un des points mis en avant par la marque pour le confort digestif." },
    { q: "Ultra Premium Direct convient-il aux chats ?", a: "Oui. La gamme chat propose des recettes avec jusqu'à 70 % d'ingrédients d'origine animale et un niveau de taurine adapté aux besoins spécifiques des félins." },
  ],
  'dog-chef': [
    ...
    { q: "Dog Chef est-il disponible pour les chats ?", a: "Non, Dog Chef est exclusivement formulé pour les chiens. Si tu as un chat, nous te recommandons Franklin, Elmut ou Ultra Premium Direct qui proposent tous des gammes félines." },
...
const brandScoresContext: Record<string, string> = {
  ...
  'ultra-premium-direct': "Les scores Ultra Premium Direct reflètent un profil rapport qualité/prix exceptionnel grâce au modèle vente directe (jusqu'à -40 % vs marques équivalentes en animalerie). La note qualité ingrédients est solide sans être au sommet du segment — les protéines animales sont identifiées mais une part des recettes contient des protéines végétales (pois), et le taux de glucides peut grimper jusqu'à 35 % MS sur certaines formules. Sur la digestibilité, l'intégration des prébiotiques FOS et MOS est un vrai plus. Les variantes couvrent chien et chat sur croquettes, pâtées et friandises — gamme complète sans repas frais.",
...
const brandDescriptions: Record<string, string[]> = {
  ...
  'ultra-premium-direct': [
    "Ultra Premium Direct a fait le pari du circuit court : pas de distribution en animalerie, pas d'intermédiaire — la marque vend exclusivement via son propre site et son système d'abonnement. Résultat : des croquettes et pâtées de qualité premium accessibles à un prix réduit jusqu'à 40 % par rapport à des marques équivalentes en réseau classique.",
    "La composition est globalement transparente. Les recettes affichent entre 28 % et 40 % de protéines selon les gammes, sans colorants ni additifs artificiels, avec des prébiotiques FOS et MOS intégrés pour le confort digestif. L'enrobage final est réalisé à Agen, en France, même si les croquettes semi-finies sont sourcées chez des sous-traitants européens — ce n'est donc pas un 100 % Made in France strict.",
    "La gamme couvre chien et chat sur croquettes, pâtées et friandises, avec des formules adaptées à différents profils (sensibilité digestive, surpoids, senior). Le modèle d'abonnement avec ajustement automatique facilite la logistique. C'est une option à considérer pour les propriétaires qui veulent du premium accessible sans compromis sur les fondamentaux nutritionnels — à condition d'accepter quelques bémols (protéines végétales sur certaines recettes, taux de glucides parfois élevé).",
  ],
  'dog-chef': [
