...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    // @cdc i18n — hreflang seulement pour les articles dont l'URL canonique est
    // bien /blog/[slug] : ceux qui ont un `categorySlug` sont canoniques sur
    // /chien/[cat]/[slug] et publient leurs alternates depuis cette route-là.
    alternates: {
      canonical,
      languages: frontmatter.categorySlug ? undefined : alternatesForFrArticle(slug),
    },
    openGraph: {
      title: frontmatter.title,
      description: frontmatter.description,
