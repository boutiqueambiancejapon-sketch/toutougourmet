...
export const EXTRA_IMAGE_SLOTS: readonly ImageSlot[] = [
  ...
  {
    id: 'art-nourriture-bichon-havanais',
    group: 'articles',
    ratio: '3:2',
    tone: 'amber',
    imageReady: true,
    ext: 'jpeg',
    subject:
      'A chest-up editorial portrait of a Bichon Havanese dog (Bichon Havanais), long silky wavy cream-and-fawn coat cascading over the head, ears and body, drop ears covered in long soft fur framing the face, dark round expressive eyes, small black nose, calm friendly inquisitive expression, warm cream studio backdrop, soft natural daylight from the upper-left, gentle catch-light in the eyes, slight 3/4 angle, head-and-shoulders framing.',
    composition:
      'Full-bleed: the dog and the warm cream studio scene fill the entire frame edge-to-edge, dog framed head-shoulders slightly off-centre per rule-of-thirds, shallow depth of field with soft cream photographic bokeh spread across the whole frame; no reserved blank band, column or text margin.',
    decorations: ['party-hat'],
    notes:
