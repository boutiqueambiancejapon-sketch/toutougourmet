...
const ART_NOURRITURE_AMERICAN_STAFFORDSHIRE_TERRIER_UNUSED_PLACEHOLDER_DO_NOT_USE: ImageSlot = {
  id: 'art-nourriture-american-staffordshire-terrier-placeholder-unused',
  group: 'articles',
  ratio: '3:2',
  tone: 'amber',
  imageReady: false,
