...
const ART_NOURRITURE_COTON_DE_TULEAR: ImageSlot = {
  id: 'art-nourriture-coton-de-tulear',
  group: 'articles',
  ratio: '3:2',
  tone: 'amber',
  imageReady: true,
  ext: 'jpeg',
  subject:
    'A chest-up portrait of a Coton de Tuléar dog: fluffy soft pure white cotton-like coat, dark round expressive eyes, small black nose, drop ears covered in long white fur framing the face, calm friendly inquisitive expression, warm cream studio backdrop, soft natural daylight from the upper-left, gentle catch-light in the eyes, slight three-quarter angle, head-and-shoulders framing. Mixed-media editorial: photographic breed portrait combined with a hand-drawn gouache party hat in pill amber, contour #1A1109, palette cream #FAFAF8 dominant.',
  composition:
